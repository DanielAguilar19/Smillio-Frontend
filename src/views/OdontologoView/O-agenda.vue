          ...
          <div class="flex justify-content-between align-items-center mb-4 gap-3">
            ...
            <div class="flex gap-3">
              <span class="p-float-label">
                <Select v-model="selectedClinica" :options="clinicas" optionLabel="name"
                  placeholder="Filtra por Clínica" class="w-full md:w-14rem" />
              </span>
            </div>
            <div class="flex gap-3">
              <span class="p-float-label">
                <Select v-model="selectedEstados" :options="estados" optionLabel="name" placeholder="Filtra por Estado"
...
:deep(.fc-day-today) {
  ...
  /* Azul muy pálido en vez de amarillo */
}
